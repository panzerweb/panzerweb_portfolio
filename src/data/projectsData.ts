...
export const currentProjects: Projects[] = [
  ...
  },
  {
    ...
    coverFile: '',
    description:
      'A powerful yet straightforward debt tracker system specially built for MSMEs in a local environment setting. This is originally built for a smal retail store in the Philippines called Sari-Sari stores.',
    techstack: [
      findTechStack('JavaScript'),
      findTechStack('Php'),
      findTechStack('Bootstrap5'),
